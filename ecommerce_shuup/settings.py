...
BASE_DIR = env(
    "SHUUP_WORKBENCH_BASE_DIR",
    default=Path(__file__).resolve(strict=True).parent.parent,
)

APPS_DIR = BASE_DIR / "ecommerce_shuup"

READ_DOT_ENV_FILE = env.bool("DJANGO_READ_DOT_ENV_FILE", default=False)
if READ_DOT_ENV_FILE:
    env.read_env(str(BASE_DIR / ".env"))

SECRET_KEY = 'lro_u++ukyrntb#hjaas+p^m+!+g*4o)^ei+^dh^#!uf@n4#ih'
...
SHUUP_ENABLED_ADDONS_FILE = env(
    "SHUUP_ENABLED_ADDONS_FILE", 
    default=BASE_DIR / "enabled_addons"
)
...
ROOT_URLCONF = "ecommerce_shuup.urls"
WSGI_APPLICATION = "ecommerce_shuup.wsgi.application"
